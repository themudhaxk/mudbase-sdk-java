...
public class Example {
  public static void main(String[] args) {
    ...
    RoleElevationApi apiInstance = new RoleElevationApi(defaultClient);
    String projectId = "projectId_example"; // String | Project ID.
    RoleElevationRequestRequest roleElevationRequestRequest = new RoleElevationRequestRequest(); // RoleElevationRequestRequest | Role slug to request elevation to (e.g. a higher-privilege role you configured).
    try {
