...
import com.mudbase.sdk.api.AuthApi;
...
> MessageResponse authResendVerification(authResendVerificationRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    AuthApi apiInstance = new AuthApi(defaultClient);
    AuthResendVerificationRequest authResendVerificationRequest = new AuthResendVerificationRequest(); // AuthResendVerificationRequest | Email address to resend to; optional `projectId` for project-scoped verification links.
    try {
      MessageResponse result = apiInstance.authResendVerification(authResendVerificationRequest);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling AuthApi#authResendVerification");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
# **authVerifyEmail**
> MessageResponse authVerifyEmail(authVerifyEmailRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    AuthApi apiInstance = new AuthApi(defaultClient);
    AuthVerifyEmailRequest authVerifyEmailRequest = new AuthVerifyEmailRequest(); // AuthVerifyEmailRequest | Verification token from the email link; optional `projectId` for project-scoped signup.
    try {
      MessageResponse result = apiInstance.authVerifyEmail(authVerifyEmailRequest);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling AuthApi#authVerifyEmail");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
