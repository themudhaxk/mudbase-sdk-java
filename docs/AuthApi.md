...
public class Example {
  public static void main(String[] args) {
    ...
    AuthApi apiInstance = new AuthApi(defaultClient);
    AuthResendVerificationRequest authResendVerificationRequest = new AuthResendVerificationRequest(); // AuthResendVerificationRequest | 
    try {
...
public class Example {
  public static void main(String[] args) {
    ...
    AuthApi apiInstance = new AuthApi(defaultClient);
    AuthVerifyEmailRequest authVerifyEmailRequest = new AuthVerifyEmailRequest(); // AuthVerifyEmailRequest | 
    try {
