...
# **integrationsExecute**
> MultiRoleGetPermissionsMatrix200Response integrationsExecute(projectId, integrationId, integrationsExecuteRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      MultiRoleGetPermissionsMatrix200Response result = apiInstance.integrationsExecute(projectId, integrationId, integrationsExecuteRequest);
