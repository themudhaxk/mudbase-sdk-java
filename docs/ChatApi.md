...
public class Example {
  public static void main(String[] args) {
    ...
    String chatId = "chatId_example"; // String | Chat ID.
    String messageId = "messageId_example"; // String | Message ID.
    ChatEditMessageRequest chatEditMessageRequest = new ChatEditMessageRequest(); // ChatEditMessageRequest | New plaintext content (non-E2EE messages) or new e2ee ciphertext (E2EE messages). One of content or e2ee.ciphertext is required.
    try {
...
<a id="chatGetChatE2eeParticipantKeys"></a>
# **chatGetChatE2eeParticipantKeys**
> ChatGetChatE2eeParticipantKeys200Response chatGetChatE2eeParticipantKeys(projectId, chatId)
...
public class Example {
  public static void main(String[] args) {
    ...
    String chatId = "chatId_example"; // String | Chat ID.
    try {
      ChatGetChatE2eeParticipantKeys200Response result = apiInstance.chatGetChatE2eeParticipantKeys(projectId, chatId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ChatApi#chatGetChatE2eeParticipantKeys");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="chatPutChatE2eeKey"></a>
# **chatPutChatE2eeKey**
> ChatPutChatE2eeKey200Response chatPutChatE2eeKey(projectId, chatPutChatE2eeKeyRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    ChatApi apiInstance = new ChatApi(defaultClient);
    String projectId = "projectId_example"; // String | Project ID.
    ChatPutChatE2eeKeyRequest chatPutChatE2eeKeyRequest = new ChatPutChatE2eeKeyRequest(); // ChatPutChatE2eeKeyRequest | Identity public key material for E2EE chat (base64). Private keys stay on the client.
    try {
      ChatPutChatE2eeKey200Response result = apiInstance.chatPutChatE2eeKey(projectId, chatPutChatE2eeKeyRequest);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ChatApi#chatPutChatE2eeKey");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    String projectId = "projectId_example"; // String | Project ID.
    String chatId = "chatId_example"; // String | Chat ID.
    ChatSendMessageRequest chatSendMessageRequest = new ChatSendMessageRequest(); // ChatSendMessageRequest | Message type and content, or E2EE ciphertext for text messages. Plaintext requires content; E2EE requires type=text and e2ee.ciphertext (omit plaintext content).
    try {
