...
public class Example {
  public static void main(String[] args) {
    ...
    MultiRoleApplyRoleFeaturePresetRequest multiRoleApplyRoleFeaturePresetRequest = new MultiRoleApplyRoleFeaturePresetRequest(); // MultiRoleApplyRoleFeaturePresetRequest | 
    try {
...
public class Example {
  public static void main(String[] args) {
    ...
    MultiRoleApi apiInstance = new MultiRoleApi(defaultClient);
    String projectId = "projectId_example"; // String | 
    MultiRoleSimulateAppPermissionsRequest multiRoleSimulateAppPermissionsRequest = new MultiRoleSimulateAppPermissionsRequest(); // MultiRoleSimulateAppPermissionsRequest | 
    try {
