...
<a id="multiRoleApplyRoleFeaturePreset"></a>
# **multiRoleApplyRoleFeaturePreset**
> multiRoleApplyRoleFeaturePreset(projectId, roleSlug, multiRoleApplyRoleFeaturePresetRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    String roleSlug = "roleSlug_example"; // String | Role slug to apply the preset to (e.g. `customer`).
    MultiRoleApplyRoleFeaturePresetRequest multiRoleApplyRoleFeaturePresetRequest = new MultiRoleApplyRoleFeaturePresetRequest(); // MultiRoleApplyRoleFeaturePresetRequest | JSON body with `preset` set to `admin`, `user`, or `viewer`.
    try {
      apiInstance.multiRoleApplyRoleFeaturePreset(projectId, roleSlug, multiRoleApplyRoleFeaturePresetRequest);
    } catch (ApiException e) {
      System.err.println("Exception when calling MultiRoleApi#multiRoleApplyRoleFeaturePreset");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="multiRoleGetPermissionsMatrix"></a>
# **multiRoleGetPermissionsMatrix**
> MultiRoleGetPermissionsMatrix200Response multiRoleGetPermissionsMatrix(projectId)
...
public class Example {
  public static void main(String[] args) {
    ...
    MultiRoleApi apiInstance = new MultiRoleApi(defaultClient);
    String projectId = "685ad30be129932fbb7a1047"; // String | Project ID whose multi-role matrix is returned.
    try {
      MultiRoleGetPermissionsMatrix200Response result = apiInstance.multiRoleGetPermissionsMatrix(projectId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling MultiRoleApi#multiRoleGetPermissionsMatrix");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="multiRoleSimulateAppPermissions"></a>
# **multiRoleSimulateAppPermissions**
> Object multiRoleSimulateAppPermissions(projectId, multiRoleSimulateAppPermissionsRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    MultiRoleApi apiInstance = new MultiRoleApi(defaultClient);
    String projectId = "projectId_example"; // String | Project ID used to resolve role configuration.
    MultiRoleSimulateAppPermissionsRequest multiRoleSimulateAppPermissionsRequest = new MultiRoleSimulateAppPermissionsRequest(); // MultiRoleSimulateAppPermissionsRequest | Role slug plus either OpenAPI `operationId` or HTTP `method` and `pathname` to evaluate.
    try {
      Object result = apiInstance.multiRoleSimulateAppPermissions(projectId, multiRoleSimulateAppPermissionsRequest);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling MultiRoleApi#multiRoleSimulateAppPermissions");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    MultiRoleApi apiInstance = new MultiRoleApi(defaultClient);
    String projectId = "685ad30be129932fbb7a1047"; // String | Project ID.
    MultiRoleUpdateSettingsRequest multiRoleUpdateSettingsRequest = new MultiRoleUpdateSettingsRequest(); // MultiRoleUpdateSettingsRequest | Feature flags only — not per-role approval. Use `settings.allowMultipleRoles`, `requireRoleSelection`, `autoAssignDefault`, `dataOwnerField`.
    try {
