...
# **walletTestWebhook**
> MultiRoleGetPermissionsMatrix200Response walletTestWebhook(walletTestWebhookRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      MultiRoleGetPermissionsMatrix200Response result = apiInstance.walletTestWebhook(walletTestWebhookRequest);
      System.out.println(result);
    } catch (ApiException e) {
