...
import com.mudbase.sdk.auth.Authentication;
import com.mudbase.sdk.auth.HttpBasicAuth;
import com.mudbase.sdk.auth.HttpBearerAuth;
...
public class ApiClient {
    ...
    protected void init() {
        ...
        setUserAgent("OpenAPI-Generator/1.3.16/java");
     ...
     * @return a {@link com.mudbase.sdk.ApiClient} object
     */
    ...
    */
     ...
     * @throws com.mudbase.sdk.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws com.mudbase.sdk.ApiException If fail to serialize the given object
     */
     ...
     * @throws com.mudbase.sdk.ApiException If fail to read file content from response and write to disk
     ...
     * @throws com.mudbase.sdk.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws com.mudbase.sdk.ApiException If the response has an unsuccessful status code or
     ...
     * @throws com.mudbase.sdk.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws com.mudbase.sdk.ApiException If fails to update the parameters
     */
     ...
     * @throws com.mudbase.sdk.ApiException If fail to serialize the request body object into a string
     */
